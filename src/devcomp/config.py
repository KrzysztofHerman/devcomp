    ...
    def _generate_netlist(self):
        ...
        if simulator == "spectre":
            ...
            netlist = [
                ...
                f'\n',
                f'\n',
                f'L_X1          _net0      gate_n          1M',
                f'C_X1            in       gate_n          1M',
                f'L_X2          drain_n    _net1           1M',
                f'C_X2          drain_n     out            1M',
                f'Vgs          _net0        GND     DC  {Vgs}',
                f'Vb_n      source_n        GND     DC   0',
                f'Vs_n        bulk_n        GND     DC   0',
                f'VP1             in        GND dc 0 ac 0.632456 SIN(0 0.632456 1MEG) portnum 1 z0 50',
                f'VP2             out       GND dc 0 ac 0.000656 SIN(0 0.632456 1MEG) portnum 2 z0 50',
                f'Vds           _net1       GND     DC  {Vds}',
                ...
                f'.control',
                f'*---- NMOS',
                f'sp dec 67 100MEG 65G 1',
                f'wrdata sparam-1.csv NF NFmin RN SOpt',
                f'.endc',
                f'.GLOBAL GND',
                f'.end',
            ]
